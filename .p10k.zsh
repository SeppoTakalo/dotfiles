# Generated by Powerlevel10k configuration wizard on 2020-12-01 at 13:46 EET.
...
() {
  ...
  function prompt_my_west() {
    if [ -z "$ZEPHYR_BASE" ] || ! which west >/dev/null; then
        return
    fi
    p10k segment -f 208 -i '' -t "manifest=$(west config manifest.path)"
  }
